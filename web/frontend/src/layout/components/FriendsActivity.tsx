...
const FriendsActivity = () => {
	...
	return (
		<div className="h-full bg-zinc-900 rounded-lg flex flex-col">
			...
			{/* HEADER SOLO SI HAY AMIGOS */}
			{user && users.length > 0 && (
				<div className="p-4 flex justify-between items-center border-b border-zinc-800">
					<div className="flex items-center gap-2">
						<Users className="size-5 shrink-0 mr-3" />
			...
			{/* LOGGED IN BUT NO FRIENDS → SHOW CUSTOM BLOCK */}
			{user && users.length === 0 && <NoFriendsPrompt />}

			{/* LISTA SOLO SI HAY AMIGOS */}
			{user && users.length > 0 && (
		...
		<div className="h-full flex flex-col items-center justify-center p-6 text-center space-y-4">
			...
			<div className="space-y-2 max-w-[250px]">
				...
				<p className="text-sm text-zinc-400">
					Add or follow friends to see what they're listening to.
				</p>
			</div>
		</div>
	);
